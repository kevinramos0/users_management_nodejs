...
import { RefreshToken } from '../app/models/index.mjs';
...
export default class Auth {
  ...
  static async refresh_token(id) {
    ...
    const result = await RefreshToken.create({
      ...
      id_user: id,
      dateValid: moment().add(process.env.TIME_TOKEN_REFRESH, process.env.TYPE_TIME_TOKEN_REFRES).tz('America/El_Salvador').format(),
    });
